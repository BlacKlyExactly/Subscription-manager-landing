...
export function HowItWorksCard({
  ...
  return (
    <article
      className={cn(
        "card sm:w-2/3 dark:shadow-black/10 shadow-lg shadow-foreground/5 px-6 py-7.5 lg:w-full rounded-3xl flex flex-col items-center",
        highlightClassName,
      )}
    >
      {children}
      <Slot className="text-primary size-13">{icon}</Slot>
