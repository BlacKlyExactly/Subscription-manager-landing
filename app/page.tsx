...
import coverDesktopDark from "@/assets/cover-desktop-dark.png";
import coverMobileDark from "@/assets/cover-mobile-dark.png";
    ...
    <Main>
      <CroppedContainer className="text-center flex flex-col gap-7 items-center">
        <Typography size="h1" className="lg:max-w-2xl mx-auto">
          Twoje <span className="text-primary">subskrypcje</span> kosztują
          więcej niż myślisz.
        </Typography>
      ...
      <CroppedContainer className="group relative hero rounded-3xl mx-6 px-0 md:mx-auto md:px-6">
        ...
        {mounted && (
          <Image
            ...
            loading="eager"
            src={cover}
            className="shadow-2xl shadow-foreground/10 dark:shadow-none transform-[perspective(800px)_rotateX(9deg)_scale(0.97)] aspect-9/16 object-cover h-auto md:aspect-video rounded-3xl mt-16 card mb-8"
          />
        )}
      </CroppedContainer>
      <Section>
        <div>
          <Typography size="h2">
            Jak to działa w <span className="text-primary">3 prostych</span>{" "}
            krokach
          </Typography>
          <Typography className="mt-3 lg:mt-0">
            Zacznij w kilka minut, oszczędzaj przez lata
          </Typography>
        </div>
        <div className="mt-8 lg:mt-12 flex flex-col gap-4 items-center lg:flex-row lg:items-stretch">
          <HowItWorksCard
            highlight="bl"
            icon={<CreditCard />}
          ...
          <HowItWorksCard
            highlight="tl"
            icon={<Eye />}
            title="Zobacz ile naprawdę wydajesz"
          ...
          <HowItWorksCard
            highlight="tr"
            icon={<Bell />}
            title="Reaguj przed odnowieniem"
      ...
      <Section disableCrop>
        <CroppedContainer>
          <Typography size="h2">Opinie użytkowników</Typography>
          <Typography className="mt-3 lg:mt-0">
            Nie wierz nam na słowo –{" "}
            <span className="text-primary">posłuchaj innych</span>
          </Typography>
        </CroppedContainer>
      ...
      <Section disableCrop>
        <AnimatedGrid />
        <div>
          <Typography size="h2">Wybierz swój plan</Typography>
          <Typography className="mt-3 lg:mt-0">
            Zacznij <span className="text-primary">za darmo</span>, rozszerz gdy
            będziesz gotowy
          </Typography>
        </div>
